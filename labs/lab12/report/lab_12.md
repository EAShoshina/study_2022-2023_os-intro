...
![Рис. 2.12: Текст первой программы](image/2.12.png){ #fig:001 width=70% height=70%}

![Рис. 3.12: Результат](image/3.12.png){ #fig:002 width=70% height=70%} 
...
![Рис. 4.12: Gedit prog2.sh](image/4.12.png){ #fig:004 width=70% height=70%} 

![Рис. 5.12: Текст второй программы](image/5.12.png){ #fig:003 width=70% height=70%} 

![Рис. 6.12 Результат](image/6.12.png){ #fig:005 width=70% height=70%} 
...
![Рис. 7.12: Gedit prog3.sh](image/7.12.png){ #fig:004 width=70% height=70%} 

![Рис. 8.12: Текст третьей программы](image/8.12.png){ #fig:006 width=70% height=70%}  

![Рис. 9.12: Результат](image/9.12.png){ #fig:007 width=70% height=70%}  
...
6. Проверьте, верен ли синтаксис данной конструкции 1 for ((a=1; a <= LIMIT; a++)) for ((a=1; a <= LIMIT; a++))
