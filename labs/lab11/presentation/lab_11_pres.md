...
![Рис. 1.11: Первая программа](image/1.11.png) { #fig:001 width=70% height=70%}

## Вызов программы в терминале 

![Рис. 2.11: Вызов программы в терминале](image/2.11.png) { #fig:002 width=70% height=70%}

## Тест-файл

![Рис. 3.11: Тест-файл](image/3.11.png) { #fig:003 width=70% height=70%}

## Результат 

![Рис. 4.11: Результат](image/4.11.png) { #fig:004 width=70% height=70%}

# 2. Написать на языке Си программу, которая вводит число и определяет, является ли оно больше нуля, меньше нуля или равно нулю. Затем программа завершается с помощью функции exit(n), передавая информацию в о коде завершения в оболочку. Командный файл должен вызывать эту программу и, проанализировав с помощью команды $?, выдать сообщение о том, какое число было введено. (рис. 5.11, 6.11, 7.11)

## Программа на языке С

![Рис. 5.11: Вторая программа](image/5.11.png) { #fig:005 width=70% height=70%}

## Вторая программа

![Рис. 6.11: Вторая программа](image/6.11.png) { #fig:006 width=70% height=70%}

## Результат

![Рис. 7.11: Результат](image/7.11.png) { #fig:007 width=70% height=70%}
...
![Рис. 8.11: Третья программа](image/8.11.png) { #fig:008 width=70% height=70%}

## Результат

![Рис. 9.11: Результат](image/9.11.png) { #fig:009 width=70% height=70%}
...
![Рис. 10.11: Четвертая программа](image/10.11.png) { #fig:010 width=70% height=70%}

## Вызов программы в терминале

![Рис. 11.11: Вызов программы в терминале](image/11.11.png) { #fig:011 width=70% height=70%}

## Результат

![Рис. 12.11: Результат](image/12.11.png){ #fig:012 width=70% height=70%}
